...
const FundRiserCard = ({props,pushWithdrawRequests}) => {
  ...
  return (
    ...
    <div className='card flex relative overflow-hidden my-4'>
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="inner-card my-6 w-full lg:w-2/5">
          <p className="text-md white-heading">Target</p>
      ...
      <div className='flex-1 h-10'>
          <img className='object-cover rounded-full p-5 aspect-[1/1]' src={props.image}/>
      </div>
    </div>
